...
############################################################
         ...
         INFO GEMPA TERKINI 
    Mod By      : HACKER CYBER TEAM TEGAL
    Contact Me  : mochamadhamdhan@gmail.com
    Blog        : www.hamdhan.blognive.com
    Youtube     : Hamdhan Channel97
    Instagram   : @muhamadhamdansobirin
    Thanks to   : MUHAMAD HAMDAN SOBIRIN
